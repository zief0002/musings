...
```{r}
#| label: tbl-01
#| tbl-cap: "Minneapolis reading data shown in the wide structure. Each of the repeated measures columns is highlighted."
#| echo: false
...
```{r}
#| label: tbl-02
#| tbl-cap: "Minneapolis reading data shown in the long structure. Each of student is now represented by multiple rows, with each row indicating a particular grade level. Only the data for the first four students are shown. The rows associated with the first student are highlighted."
#| echo: false
...
```{r}
#| label: tbl-03
#| tbl-cap: "Minneapolis reading data shown in the wide structure. Missing data are highlighted."
#| echo: false
#| results: "asis"
...
```{r}
#| label: tbl-04
#| tbl-cap: "First student's data in the long format."
#| echo: false
...
```{r}
#| label: fig-01
#| fig-cap: "Plot of the individual (black) and mean (red) profiles indicating change in reading scores by grade level."
...
```{r}
#| label: fig-02
#| fig-cap: "Residual plots for Model 1."
#| fig-width: 8
#| fig-height: 4
#| out-width: "100%"
#| echo: false
...
<!-- While R fitst he model, it does not produce inferential results. This is because the three effects used up all of our degrees-of-freedom from the data! Because of that, a variance estimate for the residuals cannot be computed, which in turn implies that an *F*-value cannot be computed. -->


## Analyzing the Data using RM-ANOVA

Violation of the independence asumption is a huge problem for the inferential results. When we have repeated measures data, it inevitably leads to a violation of the independence assumption. Because of that, we need to use a different model to analyze the data. One such model that allows for dependence in the residuals is the repeated measures analysis of variance (RM-ANOVA).
