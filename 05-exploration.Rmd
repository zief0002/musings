...
```{r fig-01, echo=FALSE, message=FALSE, fig.cap='Kernel density estimate for the marginal distribution of household per capita expenditures.', fig.width=5, fig.height=4}
...
```{r fig-02, fig.cap='Kernel density estimate for the distribution of household per capita expenditures conditioned on area.', fig.width=6, fig.height=4, out.width="60%"}
ggplot(data = vlss, aes(x = expend)) +
