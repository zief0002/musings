...
```{r}
#| label: fig-hist
#| fig-cap: "Histogram of the age distribution."
#| fig-alt: "Histogram of the age distribution."
#| fig-width: 5
#| fig-height: 4
#| echo: false
...
```{r}
#| label: fig-kde
#| fig-cap: "Illustration of the kernel density estimation (solid line) for *N=6* observations (vertical lines). A Gaussian kernel function (dashed lines) with a fixed smoothing parameter was centered at each observation. The figure was adapted from @sain."
#| fig-alt: "Illustration of the kernel density estimation (solid line) for *N=6* observations (vertical lines). A Gaussian kernel function (dashed lines) with a fixed smoothing parameter was centered at each observation. The figure was adapted from Sain (1994)."
#| echo: false
...
```{r}
#| label: fig-kde-age
#| fig-cap: "Kernel density plot of the age distribution using the default (Gaussian) kernel."
#| fig-alt: "Kernel density plot of the age distribution using the default (Gaussian) kernel."
#| fig-width: 5
#| fig-height: 4
...
```{r}
#| label: fig-kde-age-epi
#| fig-cap: "Kernel density plot of the age distribution using the Epanechnikov kernel. Changing the kernel has little effect on the estimation of the density; this plot looks almost identical to the density plot using the Gaussian kernel."
#| fig-alt: "Kernel density plot of the age distribution using the Epanechnikov kernel. Changing the kernel has little effect on the estimation of the density; this plot looks almost identical to the density plot using the Gaussian kernel."
#| fig-width: 5
#| fig-height: 4
...
```{r}
#| label: fig-kde-age-three
#| fig-cap: "Kernel density estimates using three different smoothing parameters. Each estimate used a Gaussian kernel. The estimate on the left used a smoothing parameter of 0.5. The estimate in the middle used a smoothing parameter of 2. The estimate on the right used a smoothing parameter of 10."
#| fig-alt: "Kernel density estimates using three different smoothing parameters. Each estimate used a Gaussian kernel. The estimate on the left used a smoothing parameter of 0.5. The estimate in the middle used a smoothing parameter of 2. The estimate on the right used a smoothing parameter of 10."
#| fig-width: 15
#| fig-height: 4
#| out-width: "100%"
#| echo: false
...
```{r}
#| label: fig-kde-age-two
#| fig-cap: "Kernel density estimates using Silverman's rule of thumb for the smoothing parameter (left-hand plot) and Sheather and Jones' method of computing the smoothing parameter, (right-hand plot)."
#| fig-alt: "Kernel density estimates using Silverman's rule of thumb for the smoothing parameter (left-hand plot) and Sheather and Jones' method of computing the smoothing parameter, (right-hand plot)."
#| fig-width: 10
#| fig-height: 4
#| out-width: "100%"
#| echo: false
...
```{r}
#| label: fig-kde-age-adapt
#| fig-cap: "Density plot using adaptive kernel density estimation."
#| fig-alt: "Density plot using adaptive kernel density estimation."
#| fig-width: 5
#| fig-height: 4
